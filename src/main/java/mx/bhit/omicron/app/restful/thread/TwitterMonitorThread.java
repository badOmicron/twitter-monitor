...
public class TwitterMonitorThread implements Callable<SocialNetworksMonitoredData> {
	 ...
	 * @param query
	 */
	public TwitterMonitorThread(Boolean query, String expression, String topic) {
		this.query = query;
	...
	private SocialNetworksMonitoredData getData() {
		try {
			...
			Wp2KafkaProducer Wp2KafkaProducer = new Wp2KafkaProducer(topic);
	...
	/**
	 * @param socialNetworksMonitoredData
	 *            parametro socialNetworksMonitoredData a actualizar
	 */
	...
	/**
	 * @param expression
	 *            parametro expression a actualizar
	 */
